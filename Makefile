...
GAMEPROJECTFILE =/home/beau/Documents/Unreal Projects/CrystalCavern/CrystalCavern.uproject

TARGETS = \
	CrystalCavern-Linux-Debug  \
	CrystalCavern-Linux-DebugGame  \
	CrystalCavern-Linux-Shipping  \
	CrystalCavern-Linux-Test  \
	CrystalCavern \
	CrystalCavernEditor-Linux-Debug  \
	CrystalCavernEditor-Linux-DebugGame  \
	CrystalCavernEditor-Linux-Shipping  \
	CrystalCavernEditor-Linux-Test  \
	CrystalCavernEditor \
...
CrystalCavern-Linux-Debug:
	 $(PROJECTBUILD) CrystalCavern Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavern-Linux-DebugGame:
	 $(PROJECTBUILD) CrystalCavern Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavern-Linux-Shipping:
	 $(PROJECTBUILD) CrystalCavern Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavern-Linux-Test:
	 $(PROJECTBUILD) CrystalCavern Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavern:
	 $(PROJECTBUILD) CrystalCavern Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavernEditor-Linux-Debug:
	 $(PROJECTBUILD) CrystalCavernEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavernEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CrystalCavernEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavernEditor-Linux-Shipping:
	 $(PROJECTBUILD) CrystalCavernEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavernEditor-Linux-Test:
	 $(PROJECTBUILD) CrystalCavernEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CrystalCavernEditor:
	 $(PROJECTBUILD) CrystalCavernEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
